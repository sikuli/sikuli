...
Sikuli is hosted on http://launchpad.net/sikuli using the Bazaar version
control system (http://bazaar.canonical.com). If you don't have Bazaar 
...
If you are looking for the experimental branch of Sikuli (Sikuli-X), 
please check it out with this command instead:

      bzr branch lp:sikuli/sikuli-x
