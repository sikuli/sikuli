...
public:
  ...
  Observer(int event_type, const char* param_image_filename, float similarity, int handler_id, int x, int y, int w, int h);
  ~Observer();
...
public:
  ...
  void addObserver(int event_type, const char* param_image_filename, float similarity, int handler_id, int x, int y, int w, int h);
